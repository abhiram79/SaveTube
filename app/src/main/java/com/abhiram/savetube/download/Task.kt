...
import com.abhiram.savetube.download.Task.ViewState
...
data class Task(
    ...
    @Serializable
    savetubeed interface DownloadState : Comparable<DownloadState> {
    ...
    @Serializable
    savetubeed interface RestartableAction {
