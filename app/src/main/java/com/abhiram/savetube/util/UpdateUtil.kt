...
import com.abhiram.savetube.util.FileUtil.getFileProvider
...
object UpdateUtil {
    ...
    private const val OWNER = "abhiram"
    private const val REPO = "savetube"
    ...
    savetubeed class DownloadStatus {
