package com.abhiram.savetube.ui.theme
...
@Composable
@Deprecated("Use savetubeTheme instead", replaceWith = ReplaceWith("savetubeTheme(content)"))
fun PreviewThemeLight(content: @Composable () -> Unit) {
    savetubeTheme(darkTheme = false, content = content)
}
